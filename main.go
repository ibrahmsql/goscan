...
// printBanner prints a colored ASCII art banner for the goscan tool.
// If printHelp is true, it also displays usage instructions and version information.
...
// main is the entry point for the goscan directory scanner.
// It parses command-line arguments, initializes configuration and logging, runs the scan, and prints color-coded results and summary statistics to the console.
func main() {
